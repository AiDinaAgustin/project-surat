...
<nav class="blue-grey darken-1">
    <div class="nav-wrapper">
        <a href="./" class="brand-logo center hide-on-large-only"><i class="material-icons md-36">school</i> KSP</a>
            ...
            <li class="no-padding">
                ...
                <ul class="collapsible collapsible-accordion">
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="?page=tsm">Notulensi</a></li>
                                <li><a href="?page=tsk">Surat</a></li>
                            </ul>
                        </div>
                   </li>
                </ul>
            ...
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="?page=asm">Notulensi</a></li>
                                <li><a href="?page=ask">Surat</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
            ...
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="?page=gsm">Notulensi</a></li>
                                <li><a href="?page=gsk">Surat</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
