        ...
        <div class="row">
            ...
            <a href="?page=tsm">
                <div class="col s12 m4">
                    <div class="card cyan">
                        <div class="card-content">
                            <span class="card-title white-text"><i class="material-icons md-36">mail</i> Jumlah Notulensi</span>
                            <?php echo '<h5 class="white-text link">'.$count1.' Notulensi</h5>'; ?>
                        </div>
                    </div>
                </div>
            </a>
            ...
            <a href="?page=tsk">
                <div class="col s12 m4">
                    <div class="card lime darken-1">
                        <div class="card-content">
                            <span class="card-title white-text"><i class="material-icons md-36">drafts</i> Jumlah Surat</span>
                            <?php echo '<h5 class="white-text link">'.$count2.' Surat</h5>'; ?>
                        </div>
                    </div>
                </div>
            </a>
